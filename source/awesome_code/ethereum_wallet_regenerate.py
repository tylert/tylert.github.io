...
MNEMONIC: str = 'source clip expand robot earth debate rigid cluster input dice square route elder primary funny torch pill caught stage skate vibrant mind exchange purchase'
